...
function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      src: social_media,
      description:
        "It is an application of what you learned in ( JavaScript Advanced and Restful API) and how to work with api using REST-API in javascript.",
      url: "https://social-media-js-rest-api.netlify.app/",
      code: "https://github.com/Ahmed-Alabadla/Social-Media-JS-REST-API",
      done: true,
      showCode: true,
    },
    {
    ...
    },
    {
      ...
      src: cartApp,
      description:
        "It is an application of what you learned in ( Tailwind CSS , React JS and Redux Toolkit ) and how to work with api using redux thunk.",
      url: "https://cart-app-mu.vercel.app/",
      code: "https://github.com/Ahmed-Alabadla/Cart-App",
      done: true,
      showCode: true,
    },
    // {
